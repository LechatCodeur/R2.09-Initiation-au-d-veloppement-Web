 ...
 */
class getVieNoteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VieNoteRepository' shared autowired service.
     *
     * @return \App\Repository\VieNoteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VieNoteRepository.php';

        return $container->privates['App\\Repository\\VieNoteRepository'] = new \App\Repository\VieNoteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
